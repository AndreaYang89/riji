    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20, paddingTop: 8 }}>
      ...
      <div style={{ background: 'white', borderRadius: 32, padding: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', border: '4px solid white', boxShadow: '0 2px 10px rgba(0,0,0,0.04)' }}>
        <div style={{ display: 'flex', gap: 16, zIndex: 10 }}>
          ...
          <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <div style={{ width: 52, height: 52, background: 'white', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24, border: partnerNeedsComfort ? '3px solid #c7d2fe' : '3px solid #f1f5f9', animation: partnerNeedsComfort ? 'pulse 2s infinite' : undefined, cursor: 'pointer' }} onClick={handleComfort}>
            ...
            <button onClick={handleComfort} style={{ position: 'absolute', top: -4, right: -8, background: partnerNeedsComfort ? '#ef4444' : theme.mainColor, color: 'white', padding: 6, borderRadius: '50%', border: 'none', cursor: 'pointer', boxShadow: '0 4px 12px rgba(0,0,0,0.15)', zIndex: 20, animation: partnerNeedsComfort ? 'pulse 1.5s infinite' : undefined }}>
